...
namespace TestFormat
{
	...
	public:
		...
		TEST_CLASS_INITIALIZE(Init)
		{
			...
			options.CodePaths.push_back("D:\\proj\\src\\");
			options.CodePaths.push_back("D:\\proj\\empty\\");
			options.CodePaths.push_back("D:\\proj\\lib\\");
		...
		void WriteReport(const std::string& expectReport, RuntimeOptions::ExportFormatType exportFormat, const FileCallbackInfo::MergedProfileInfoMap& mergedProfileData)
		{
			...
			addFile(fileCallbackInfo, "D:\\proj\\src\\srcFile.cpp", createFileLineInfoArray({ {4, 4}, {4, 2}, {0, 0}, {4, 0}, {4, 2} }));
			addFile(fileCallbackInfo, "D:\\proj\\src\\srcFile.h", createFileLineInfoArray({ {6, 6}, {3, 3} }));
			addFile(fileCallbackInfo, "D:\\proj\\lib\\libFile.cpp", createFileLineInfoArray({ {7, 0}, {4, 0}, {2, 0} }));
			addFile(fileCallbackInfo, "D:\\proj\\lib\\libFile.h", createFileLineInfoArray({ {18, 12}, {14, 7}, {3, 0} }));
		...
		TEST_METHOD(WriteReportNativeWithoutProfileData)
		{
			const std::string expectReport =
				"FILE: D:\\proj\\src\\srcFile.cpp\n" \
				"RES: cp_up\n" \
				"PROF: \n" \
				"FILE: D:\\proj\\src\\srcFile.h\n" \
				"RES: cc\n" \
				"PROF: \n" \
				"FILE: D:\\proj\\lib\\libFile.cpp\n" \
				"RES: uuu\n" \
				"PROF: \n" \
				"FILE: D:\\proj\\lib\\libFile.h\n" \
				"RES: ppu\n" \
				"PROF: \n";
