...
namespace NubiloSoft.CoverageExt
{
    static class GuidList
    {
        ...
        public const string guidCppCoverageMenuCmdSetString     = "0D8FDCC0-98E9-45AD-915A-D3A3BF5DE720";
        ...
        public static readonly Guid guidCppCoverageMenuCmdSet       = new Guid(guidCppCoverageMenuCmdSetString);
    };
}